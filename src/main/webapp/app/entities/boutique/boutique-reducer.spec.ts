...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './boutique.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_BOUTIQUE_LIST actions', async () => {
    ...
    it('dispatches FETCH_BOUTIQUE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_BOUTIQUE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_BOUTIQUE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_BOUTIQUE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_BOUTIQUE actions', async () => {
      const expectedActions = [
        {
