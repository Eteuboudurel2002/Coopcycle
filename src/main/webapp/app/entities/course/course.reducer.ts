...
export const createEntity = createAsyncThunk(
  ...
  async (entity: ICourse, thunkAPI) => {
    return axios.post<ICourse>(apiUrl, cleanEntity(entity));
  },
  { serializeError: serializeAxiosError }
);
...
export const updateEntity = createAsyncThunk(
  ...
  async (entity: ICourse, thunkAPI) => {
    return axios.put<ICourse>(`${apiUrl}/${entity.id}`, cleanEntity(entity));
  },
  { serializeError: serializeAxiosError }
);
...
export const partialUpdateEntity = createAsyncThunk(
  ...
  async (entity: ICourse, thunkAPI) => {
    return axios.patch<ICourse>(`${apiUrl}/${entity.id}`, cleanEntity(entity));
  },
  { serializeError: serializeAxiosError }
);
