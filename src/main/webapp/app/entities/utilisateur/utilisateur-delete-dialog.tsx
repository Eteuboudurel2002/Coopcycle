...
export const UtilisateurDeleteDialog = () => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="coopcycleApp.utilisateur.delete.question">
        <Translate contentKey="coopcycleApp.utilisateur.delete.question" interpolate={{ id: utilisateurEntity.id }}>
