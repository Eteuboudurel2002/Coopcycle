    ...
    <Row>
      <Col md="8">
        ...
        <dl className="jh-entity-details">
          ...
          <dt>
            <span id="zone">
              <Translate contentKey="coopcycleApp.cooperative.zone">Zone</Translate>
            </span>
          </dt>
          <dd>{cooperativeEntity.zone}</dd>
          <dt>
            <Translate contentKey="coopcycleApp.cooperative.idDG">Id DG</Translate>
          </dt>
          <dd>{cooperativeEntity.idDG ? cooperativeEntity.idDG.id : ''}</dd>
          <dt>
            <Translate contentKey="coopcycleApp.cooperative.boutique">Boutique</Translate>
          </dt>
          <dd>
            {cooperativeEntity.boutiques
              ? cooperativeEntity.boutiques.map((val, i) => (
                  <span key={val.id}>
                    <a>{val.id}</a>
                    {cooperativeEntity.boutiques && i === cooperativeEntity.boutiques.length - 1 ? '' : ', '}
                  </span>
                ))
              : null}
          </dd>
