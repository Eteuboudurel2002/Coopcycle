              ...
              <thead>
                <tr>
                  ...
                  <th className="hand" onClick={sort('dateCreation')}>
                    <Translate contentKey="coopcycleApp.panier.dateCreation">Date Creation</Translate> <FontAwesomeIcon icon="sort" />
                  </th>
                  ...
                  <th className="hand" onClick={sort('statut')}>
                    <Translate contentKey="coopcycleApp.panier.statut">Statut</Translate> <FontAwesomeIcon icon="sort" />
                  </th>
                  <th className="hand" onClick={sort('total')}>
                    <Translate contentKey="coopcycleApp.panier.total">Total</Translate> <FontAwesomeIcon icon="sort" />
                  </th>
                  <th>
                    <Translate contentKey="coopcycleApp.panier.idClient">Id Client</Translate> <FontAwesomeIcon icon="sort" />
                  </th>
                  <th />
                </tr>
              </thead>
              <tbody>
                {panierList.map((panier, i) => (
                  <tr key={`entity-${i}`} data-cy="entityTable">
                    ...
                    <td>
                      {panier.dateCreation ? <TextFormat type="date" value={panier.dateCreation} format={APP_LOCAL_DATE_FORMAT} /> : null}
                    </td>
                    <td>
                      {panier.dateModification ? (
                        <TextFormat type="date" value={panier.dateModification} format={APP_LOCAL_DATE_FORMAT} />
                      ) : null}
                    </td>
                    <td>{panier.statut}</td>
                    <td>{panier.total}</td>
                    <td>{panier.idClient ? <Link to={`/utilisateur/${panier.idClient.id}`}>{panier.idClient.id}</Link> : ''}</td>
