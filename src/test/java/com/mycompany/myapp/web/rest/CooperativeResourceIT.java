...
class CooperativeResourceIT {
    ...
    public static Cooperative createEntity(EntityManager em) {
        Cooperative cooperative = new Cooperative().name(DEFAULT_NAME).zone(DEFAULT_ZONE);
        // Add required entity
        ...
        cooperative.setIdDG(utilisateur);
        return cooperative;
    }
    ...
    public static Cooperative createUpdatedEntity(EntityManager em) {
        Cooperative cooperative = new Cooperative().name(UPDATED_NAME).zone(UPDATED_ZONE);
        // Add required entity
        Utilisateur utilisateur;
        if (TestUtil.findAll(em, Utilisateur.class).isEmpty()) {
    ...
    void createCooperative() throws Exception {
        ...
        assertThat(testCooperative.getZone()).isEqualTo(DEFAULT_ZONE);
    }
    ...
    void getAllCooperativesWithEagerRelationshipsIsNotEnabled() throws Exception {
        ...
        restCooperativeMockMvc.perform(get(ENTITY_API_URL + "?eagerload=false")).andExpect(status().isOk());
        verify(cooperativeRepositoryMock, times(1)).findAll(any(Pageable.class));
    }
    ...
    void putExistingCooperative() throws Exception {
        ...
        updatedCooperative.name(UPDATED_NAME).zone(UPDATED_ZONE);
        ...
        assertThat(testCooperative.getZone()).isEqualTo(UPDATED_ZONE);
    }
    ...
    void partialUpdateCooperativeWithPatch() throws Exception {
        ...
        partialUpdatedCooperative.zone(UPDATED_ZONE);
    ...
    void fullUpdateCooperativeWithPatch() throws Exception {
        ...
        partialUpdatedCooperative.name(UPDATED_NAME).zone(UPDATED_ZONE);
