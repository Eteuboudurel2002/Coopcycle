...
class UtilisateurResourceIT {
    ...
    private static final String DEFAULT_EMAIL = "dh+vrK@7.JS";
    private static final String UPDATED_EMAIL = "mcc%D4@O.Jitvo";

    private static final String DEFAULT_TEL = "0282 69 6211";
    private static final String UPDATED_TEL = "01 743058 54";

    private static final Role DEFAULT_ROLE = Role.CLIENT;
    private static final Role UPDATED_ROLE = Role.ARTISANT;
    ...
    void createUtilisateur() throws Exception {
        ...
        assertThat(testUtilisateur.getAge()).isEqualTo(DEFAULT_AGE);
    ...
    void putExistingUtilisateur() throws Exception {
        ...
        assertThat(testUtilisateur.getAge()).isEqualTo(UPDATED_AGE);
    ...
    void partialUpdateUtilisateurWithPatch() throws Exception {
        ...
        partialUpdatedUtilisateur.address(UPDATED_ADDRESS).role(UPDATED_ROLE);
